                                ...
                                <tbody>
                                    ...
                                    <tr id="rowPenginap">
                                        ...
                                        <td>
                                            ...
                                            <button type="button" class="btn-sm btn-primary" data-toggle="modal" data-target="#ModalPerpanjang" data-idpenginap="{{ $item['id_penginap'] }}">Perpanjang</button>
                                        </td>
                                    </tr>
                                    @else continue
                                    @endif
                ...
                <div class="modal-body">
                    <div class="container fluid">
                        <div class="form-group">
                            ...
                            <input id="kodeBooking" name="cc-payment" type="text" class="form-control" aria-required="true" aria-invalid="false" readonly>
                        </div>
                    ...
                    <div class="modal-footer">
                        ...
                        <button id="prosesCheckout" type="button" class="btn btn-warning">Proses Checkout</button>
                    </div>
                </div>
            </div>
        </div>
